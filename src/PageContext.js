...
export function PageProvider({children}){
    ...
    return(
        <PageContext.Provider value={{screen, setScreen, screenPosition, setScreenPosition, courses, addCourses, selectedCourse, setSelectedCourse, events, addEvents, savingStatus, setSavingStatus}}>
            {children}
